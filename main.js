  ...
  client.on("group-participants-update", async (anu) => {
    try {
      ...
      if (anu.action == "add" && mem.includes(client.user.jid)) {
        client.sendMessage(anu.jid, "Halo! my name is Kakek saya di undang oleh owner Legend dan saya di buat degan bahasa pemograman Nodejs untuk menampilkan menu ku ketik *.menu* terimakasih", "conversation");
      }
      if (anu.action == "add" && !mem.includes(client.user.jid)) {
