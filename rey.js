...
//    const isCmd = body.startsWith(prefix)
    ...
    quoted: {
	 ...
	 message: {
        groupInviteMessage: {
          groupJid: "994404117844-1616169743@g.us",
          inviteCode: "m",
          groupName: "P",
          caption: fake,
          jpegThumbnail: thumb,
    ...
    const fakestatus = (teks) => {
      client.sendMessage(from, teks, text, {
        quoted: {
          key: {
            fromMe: false,
            participant: `994404117844@s.whatsapp.net`,
      ...
      client.sendMessage(from, teks, text, {
        quoted: {
          key: {
            fromMe: false,
            participant: `0@s.whatsapp.net`,
            ...(from ? { remoteJid: "994404117844-1604595598@g.us" } : {}),
          },
          message: {
            imageMessage: {
              url: "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc",
      ...
      message: {
        productMessage: {
          product: {
            ...
            title: "Legend", //Kasih namalu
            description: "Kakek Legend",
            currencyCode: "USD",
   ...
   const sendButLocation = async (
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "994404117844@s.whatsapp.net";
...
`
sendButLocation(from, `_*WELCOME TO LEGEND BOT*_`, `${halah}`, {jpegThumbnail:ganz}, [{buttonId:`${prefix}?`,buttonText:{displayText:'menu 📜'},type:1},{buttonId:`${prefix}donasi`,buttonText:{displayText:'donasi 🎁'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'owner 🌹'},type:1}], {contextInfo: { mentionedJid: [mark]}})
break;
...
🌹 *Whatsapp Grub Legend Bot*
*https://chat.whatsapp.com/K2Y0wGMPgVrDTuAjmPqhsH
...
sendButImage(from, `nihhh ngab🗿`, `lanjut?`, gim, [
      ...
      case "thanks":
          ...
          break
      case "dana":
       sendButMessage(from, `hallo kack mau donasi lewat dana? Langsung aja kirim ke 994404117844`, `terimakasih telah mau berdonasi ❤️`, [
            {
              buttonId: `${prefix}menu`,
              buttonText: {
                displayText: `back menu`,
         ...
         break;
      case "saweria":
       sendButMessage(from, `hallo kack mau donasi lewat saweria? Langsung aja ke chat owner`, `terimakasih telah mau berdonasi ❤️`, [
            {
              buttonId: `${prefix}menu`,
              buttonText: {
                displayText: `back menu`,
         ...
         break;
      case "trakker":
        sendButMessage(from, `hallo kak mau donasi lewat trakker ya langsung aja ke chat owner`, `Terimakasih telah mau berdonasi ❤️`, [
            {
              buttonId: `${prefix}menu`,
              buttonText: {
                displayText: `back menu`,
...
➸ Type: ${reminder.getReminderType(sender, _reminder)}`,
        ...
        break;
       case "jadibot":
           sendButMessage(from, `maaf fitur di lock oleh owner silahkan hubungi owner https://github.com/`, `customize by sekha`, [
            {
...
//        if (!mek.key.fromMe) return fakestatus("SELF-BOT");
      ...
      case "setreply":
      case "setfake":
        if (!mek.key.fromMe) return reply('*Kamu owner Legend??*')
...
//        if (!mek.key.fromMe) return reply('*Kamu owner Erza??*')
  ...
  //      if (!mek.key.fromMe) return reply('*Kamu owner Erza??*')
      ...
      case "term":
        ...
        if (!q) return fakegroup(mess.wrongFormat);
        exec(q, (err, stdout) => {
          if (err) return fakegroup(`KAKEK LEGEND:~ ${err}`);
          if (stdout) {
            fakegroup(stdout);
          }
        });
